...
const otherList: IOtherList = {
  ustav: {
    add: 'ustav',
    ru: 'О порядке келейного (домашнего) чтения псалтири',
    cs: 'Ўстaвъ ст7hхъ nтє1цъ'
  },
  start: {
    add: 'start',
    ru: 'Молитвы перед началом чтения Псалтири',
    cs: 'Разyмно да бyдетъ, кaкw подобaетъ o3с0бь пёти pалти1рь'
  },
  end: {
    add: 'end',
    ru: 'Молитвы по прочтении нескольких кафисм или всей Псалтири',
    cs: 'По совершeніи же нёколикихъ каfjсмъ, и3ли2 все1й pалти1ри'
  },
  posled: {
    add: 'posled',
    ru: 'Последование по исходе души от тела',
    cs: 'Послёдованіе по и3сх0дэ души2 t тёла'
  },
  pomannik: {
    add: 'pomannik',
    ru: undefined,
  ...
  p12: {
    chin: 'p12',
    ru: 'Чин чтения 12-ти псалмов',
    cs: 'Чин чтения 12-ти псалмов',
    forceRu: true
  },
  songs: {
    songs: 'songs',
    ru: 'Песни Священного Писания',
    cs: 'Пэ~сни свzще~ннагw писа~ніz.'
  }
};

export class Contents {
  public static getKafismaList(): IKafismaList {
    return kafismaList;
  }

  public static getOtherList(): IOtherList {
    return otherList;
  }

  public static getKafismaItem(id: string): IKafismaItem {
