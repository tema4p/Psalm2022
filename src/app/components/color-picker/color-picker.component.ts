...
@Component({
  ...
  template: `<canvas #chooser style="background:white; margin-top: 20px; margin-bottom: 20px; " class='center'></canvas>
  <canvas #palette style="background:white;" class='center'></canvas>`
})
